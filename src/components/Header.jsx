...
const Header = () => {
  ...
  return (
    <header className='px-4 py-5 bg-white border-0'>
      <div className='md:flex md:justify-between'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4'>
          ...
          <button className='text-white text-sm bg-sky-600 p-3 rounded-md uppercase font-bold' onClick={handleCerrarSesion}>
            Cerrar sesión
          </button>
          <Busqueda />
        </div>
