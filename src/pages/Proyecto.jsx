...
const Proyecto = () => {
  ...
  const { proyecto, cargando, obtenerProyecto, handleModalTarea, submitTareasProyecto, eliminarTareaProyecto, actualizarTareaProyecto, cambiarEstadoTarea } = useProyectos();
  ...
  return (
    <>
      ...
      <div className='bg-white shadow mt-20 rounded-lg'>
